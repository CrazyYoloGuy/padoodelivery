class DeliveryApp {
    ...
    async playNotificationSound() {
        try {
            ...
            oscillator.frequency.setValueAtTime(880, this.audioContext.currentTime); // Higher frequency for notification
            ...
            this.showToast('Notification sound played', 'info');
            } catch (error) {
            console.error('Error playing notification sound:', error);
            this.showToast('Failed to play notification sound', 'error');
        }
    }
    ...
    handleNotificationUpdate(data) {
        ...
        console.log(`🔄 Processing notification update: ${action} for notification ${notificationId}`);
        
        switch (action) {
            case 'confirmed':
                this.handleNotificationConfirmed(notificationId, updateData);
                break;
            case 'deleted':
                this.handleNotificationDeleted(notificationId);
                break;
            case 'edited':
                this.handleNotificationEdited(notificationId, updateData);
                break;
            default:
                console.log('Unknown notification update action:', action);
        }
    }
    ...
    handleRealtimeNotification(notification) {
        ...
        if (existingIndex !== -1) {
            ...
            // Add as new notification (current behavior)
        ...
        this.showToast(`New notification from ${notification.shop.name}: ${notification.message}`, 'info');
